...
| 018-report-sharing.sql | pending | File written 2026-08-06 as Task 2 of client-sharing feature; migration adds columns to shared_reports and creates report_viewers table. To be run before deploying the sharing routes. |
