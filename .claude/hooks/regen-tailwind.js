...
//
// It is COMMITTED (since 2026-09-03): .gitignore un-ignores .claude/hooks/ and
// .claude/settings.json specifically so a fresh clone gets this hook and the
// settings entry that registers it. It used to be ignored and claimed to be
// installed by a setup/ folder that never existed, so only one machine had it.
//
// Rules:
...
//
// Registered in .claude/settings.json (PostToolUse on Edit|Write|MultiEdit).
